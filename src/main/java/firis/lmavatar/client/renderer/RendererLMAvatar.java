package firis.lmavatar.client.renderer;
...
import firis.lmavatar.client.renderer.layer.LayerCustomHeadLMAvatar;
import firis.lmavatar.client.renderer.layer.LayerElytraLMAvatar;
...
public class RendererLMAvatar extends RenderPlayer {
	...
	public RendererLMAvatar(RenderPlayer renderPlayer) {
        ...
        //Layer登録用イベント
   		MinecraftForge.EVENT_BUS.post(new ClientEventLMAvatar.RendererLMAvatarAddLayerEvent(this));
